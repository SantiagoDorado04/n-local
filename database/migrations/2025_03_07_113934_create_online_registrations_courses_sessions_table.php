...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('online_registrations_courses_sessions', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->text('description')->nullable();
            $table->dateTime('start_date');
            $table->dateTime('end_date');
            $table->text('non_attendance_message')->nullable();
            $table->foreignId('or_course_id')->constrained('online_registrations_courses')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('online_registrations_courses_sessions');
    }
};

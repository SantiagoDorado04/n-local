...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('online_registrations_forms', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->text('description')->nullable();
            $table->unsignedBigInteger('online_registration_course_id');
            //--timestamps usuario
            ...
            $table->timestamps();
            //-- llaves foraneas
            $table->foreign('online_registration_course_id')->references('id')->on('online_registrations_courses')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('online_registrations_forms');
    }
};

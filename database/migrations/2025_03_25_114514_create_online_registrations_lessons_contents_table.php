...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('online_registrations_lessons_contents', function (Blueprint $table) {
            $table->id();
            $table->foreignId('content_id')->constrained('online_registrations_sessions_contents')->onDelete('cascade'); // Relación con lel contenido de la sesion
    ...
    {
        Schema::dropIfExists('online_registrations_lessons_contents');
    }
};

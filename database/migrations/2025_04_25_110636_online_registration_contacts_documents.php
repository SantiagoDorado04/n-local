...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('or_contacts_documents', function (Blueprint $table) {
            $table->id();
            $table->text('url');
            ...
            $table->foreign('or_course_id')->references('id')->on('online_registrations_contacts_courses')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('or_contact_documents');
    }
};

...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('or_characterization_answers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('question_id')->references('id')->on('or_characterization_questions')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('or_characterization_answers');
    }
};

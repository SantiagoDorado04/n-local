...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('online_registrations_categories', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->text('description')->nullable();
            $table->boolean('active')->default(true);
            //--
            $table->unsignedBigInteger('online_registration_id');
    ...
    {
        Schema::dropIfExists('online_registrations_categories');
    }
};

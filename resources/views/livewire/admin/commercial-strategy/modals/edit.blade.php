                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="name" placeholder="Nombre de la estrategia comercial">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" wire:model="description" rows="10px"  placeholder="Escriba aquí la descripción..."></textarea>
                            @error('description')
                                <small class="text-danger">{{ $message}}</small>
                            @enderror
                        </div>

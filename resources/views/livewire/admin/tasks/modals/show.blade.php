    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                            <table class="table table-bordered">
                                <tr>
                                    <th rowspan="7" style="border: 1px solid #ddd;"><small>Informacion de contacto</small></th>
                                    <tr>
                                        <th  width="20%"><small>Nombre:</small></th>
                                ...
                                <tr>
                                    <th><small>Hora de la actividad:</small></th>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary pull-right" wire:click="editEvent()">Modificar</button>
                @endif

                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="is-required"><strong>Nombre etapa: </strong></label>
                        ...
                        <div class="form-group">
                            <label class=" "><strong>Enlace formulario de inscripción <small>(Si el formulario es
                                        externo)</small>: </strong></label>
                            <input type="text" class="form-control" wire:model="link"
                                placeholder="Enlace formulario de inscripcion">
                            @error('link')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label class=" "><strong>Embebido formulario de inscripción <small>(Si el formulario es
                                        externo)</small></strong>: </label>

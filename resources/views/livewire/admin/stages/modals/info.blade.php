    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" style="margin-top: 5px" value="{{ $token }}" readonly>
                                <input type="hidden" id="linkField" value="{{ $token }}">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button" onclick="copy()" title="Copiar enlace">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-right" wire:click="cancel()"><i class="fa fa-close"></i>&nbsp;{{ __('voyager::generic.close') }}</button>
            </div>
        </div>
    </div>

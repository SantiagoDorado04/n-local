<div wire:ignore.self class="modal modal-info fade" tabindex="-1" data-backdrop="static" data-keyboard="false"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form wire:submit.prevent="submit(Object.fromEntries(new FormData($event.target)))" id="social-form"
                autocomplete="off">
                            ...
                            <div class="row no-margin-bottom">
                                ...
                                @foreach ($gQuestions as $gQuestion)
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control" rows="2" name='question_{{ $gQuestion->id }}'></textarea>
                                ...
                                <div class="row no-margin-bottom">
                                    ...
                                    @foreach ($aQuestions as $aQuestion)
                                        <div class="col-lg-12">
                                            ...
                                            <textarea class="form-control" rows="2" name='question_{{ $aQuestion->id }}'></textarea>

        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    <i class="fa fa-plus-square"></i>&nbsp;Editar soporte
                </h5>
            </div>
            <div class="modal-body">
                <div class="row no-margin-bottom">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div wire:ignore>
                            <textarea class="form-control" rows="4" wire:model="body" id="content2" ></textarea>
                        </div>
                        @error('body')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="file" class="form-control" wire:model="support_attached">

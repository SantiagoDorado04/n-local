<div>
    @include('livewire.admin.process-tests.modals-appreciations.show')
    @include('livewire.admin.process-tests.modals-appreciations.create')
    @include('livewire.admin.process-tests.modals-appreciations.edit')
    @include('livewire.admin.process-tests.modals-appreciations.delete')
    ...
    @section('breadcrumbs')
        <ol class="breadcrumb hidden-xs">
            ...
            <li>
                Apreciaciones del test: {{ $processTest->name ?? '' }}
            </li>
        </ol>
    @endsection

    @section('page_title', 'Apreciaciones del test | ' . setting('admin.title'))

    @section('page_header')
        <div class="container-fluid">
            <h1 class="page-title">
                <i class="fa fa-clipboard"></i> Apreciaciones del test: {{ $processTest->name ?? '' }}
            </h1>

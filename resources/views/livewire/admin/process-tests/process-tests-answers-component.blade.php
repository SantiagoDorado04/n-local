<div>
    ...
    @include('livewire.admin.process-tests.modals-answers.preview')
    @include('livewire.admin.process-tests.modals-answers.delete')
    ...
    @section('breadcrumbs')
        <ol class="breadcrumb hidden-xs">
            ...
            <li>Respuestas del test: {{ $test->name }}
            </li>
        </ol>
    @endsection
                                    ...
                                    <tbody>
                                        @foreach ($registers as $register)
                                            @php
                                                ...
                                                $processContactTest = $contact
                                                    ->processContactTestFor($test->id)
                                                    ->first();
                                            @endphp
                                                ...
                                                <td class="horizontal-layout">
                                                    @if ($processContactTest)
                                                        ...
                                                        <button class="btn btn-success sm-b"
                                                            wire:click="downloadResult({{ $contact->id }})">
                                                            <i class="fa fa-download"></i>
                                                        </button>
                                                    @else
                                                        <p><strong>Aún no ha diligenciado el test</strong></p>

                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="is-required"><strong>Nombre del proceso: </strong></label>
                            <input type="text" class="form-control" wire:model="name"
                                placeholder="Nombre del proceso del cual se llevara registro">
                            @error('name')
                        ...
                        <div class="form-group">
                            <label class="is-required"><strong>Limite de cursos: </strong></label>
                            <input type="number" class="form-control" wire:model="course_limit" placeholder="0">
                            @error('course_limit')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>

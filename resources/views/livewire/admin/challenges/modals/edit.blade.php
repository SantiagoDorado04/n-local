                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="is-required"><strong>Titulo: </strong></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" wire:model="reminder_message" rows="5"
                                placeholder="Escriba aquí el mensaje de recordatorio..."></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" wire:model="congratulation_message" rows="5"
                                placeholder="Escriba aquí el mensaje de felicitación..."></textarea>

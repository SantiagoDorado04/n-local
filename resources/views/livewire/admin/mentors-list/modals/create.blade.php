                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="identification" placeholder="Identificacion del mentor">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="name" placeholder="Nombre del mentor">
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>

                ...
                <form wire:submit.prevent="submit(Object.fromEntries(new FormData($event.target)))"
                    ...
                    <div class="needs-validation">
                        <div id="steps-container" style="width: 600px">
                            <div class="step" style="display:{{ $count == 1 ? 'block' : 'none' }}; width:100%">
                                ...
                                <div class="row mt-1">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-primary" type="button" wire:click="searchNit"><i
                                                ...
                                                <div class="row no-margin-bottom">
                                                    ...
                                                    <div class="col-md-11">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input name="question_{{ $question->id }}.{{ $index }}" value="{{ $option->id }}" 
                                                                type="checkbox">
                                                            <label
                                                        ...
                                                        <textarea class="form-control"
                                                            name="question_{{ $question->id }}" rows="4"

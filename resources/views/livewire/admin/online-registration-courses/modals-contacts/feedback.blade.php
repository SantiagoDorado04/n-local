    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="is-required"><strong>Feedback: </strong></label>
                            <textarea class="form-control" wire:model="feedback" cols="30" rows="10"></textarea>
                            @error('feedback')
            ...
            <div class="modal-footer">
                <button class="btn btn-primary pull-right" wire:click="storeFeedback()"><i

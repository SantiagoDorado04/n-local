<div wire:ignore.self class="modal modal-info fade" tabindex="-1" data-backdrop="static" data-keyboard="false" id="create-modal-2" role="dialog">
<div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            @enderror
                            @error('HasOnlineRegistrationContactCourse')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary pull-right" wire:click="store()" @if($HasOnlineRegistrationContactCourse) disabled @endif>

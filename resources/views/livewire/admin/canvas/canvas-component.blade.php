<div>
    @include('livewire.admin.canvas.modals-questions.create')
    @include('livewire.admin.canvas.modals-questions.edit')
    @include('livewire.admin.canvas.modals-questions.delete')
    ...
    @section('page_title', 'Lienzo | ' . setting('admin.title'))

    @section('page_header')
        <div class="container-fluid">
            <h1 class="page-title">
                <i class="fa fa-cloud-upload"></i>&nbsp;Lienzo
            </h1>
        </div>
    @stop
                    ...
                    <div class="panel-body">
                        <div class="row no-margin-bottom" style="margin-bottom:12px">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-success sm-b" href="{{ route('canvas-contactList', ['id' => $this->formId]) }}"><i

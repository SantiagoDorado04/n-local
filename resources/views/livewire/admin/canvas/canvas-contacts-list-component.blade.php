<div>
    @section('breadcrumbs')
        <ol class="breadcrumb hidden-xs">
            ...
            <li>
                <a href="{{ route('canvas', ['id' => $canva->step_id]) }}">Lienzo</a>
            </li>
            <li>Respuestas</li>
        </ol>
    @endsection

    @section('page_title', 'Respuestas Canvas | ' . setting('admin.title'))

    @section('page_header')
        <div class="container-fluid">
            <h1 class="page-title">
                <i class="voyager-news"></i>Entregados - {{ $form->name }}
            </h1>
        </div>
    @stop
                    ...
                    <div class="panel-body" style="margin-bottom:0px">
                        <small>
                            <ul>
                                ...
                                <li><strong>Lienzo:</strong> {{ $step->name }}</li>
                            </ul>
                        </small>
                    </div>
                </div>

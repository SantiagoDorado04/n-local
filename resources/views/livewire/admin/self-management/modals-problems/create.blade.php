                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="is-required"><strong>Planteamiento del problema: </strong></label>
                            <textarea class="form-control" wire:model="title" rows="10" placeholder="Escriba aquí el planteamiento del problema..."></textarea>
                            @error('title')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label class="is-required"><strong>Descripción del problema y sus causas: </strong></label>
                            <textarea class="form-control" wire:model="description" rows="10" placeholder="Escriba aquí la descripción del problema y sus causas..."></textarea>
                            @error('description')
                                <small class="text-danger">{{ $message}}</small>
                            @enderror
                        </div>

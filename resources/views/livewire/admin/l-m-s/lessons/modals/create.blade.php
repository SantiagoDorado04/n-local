            ...
            <div class="modal-body">
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <label><strong>Enlace video protegido: </strong></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" wire:model="file" placeholder="URL del archivo"
                        ...
                        {{--  <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" wire:model="published" type="radio" value="1">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Sí
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" wire:model="published" type="radio" value="0">

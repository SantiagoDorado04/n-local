        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    <i class="voyager-list"></i>&nbsp;Detalles de opcion
                </h5>
            </div>
                ...
                <div class="row no-margin-bottom">
                    <div class="col-lg-12">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>{{ $conditional == true ? 'Si' : 'No' }}</td>
                            </tr>
                            <tr>
                            <tr>
                                <th>
                                    <li>Caracterizacion:</li>
                                </th>
                            </tr>
                            <tr>
                                <td>{{ $characterization_id ? $characterization_id : 'Sin formulario de caracterizacion' }}
                                </td>
                            </tr>
                            <tr>
                                <th>

<div>
    ...
    @include('livewire.admin.online-registration-characterizations.or-characterization-questions.modals-questions.delete')
    @include('livewire.admin.online-registration-characterizations.or-characterization-questions.modals-questions.edit')
    @include('livewire.admin.online-registration-characterizations.or-characterization-questions.modals-questions.create')
    @include('livewire.admin.online-registration-characterizations.or-characterization-questions.modals-questions.show')
                                            ...
                                            <div class="panel-footer">
                                                <div class="pull-right">
                                                    <a class="btn btn-success sm-b"
                                                        href="{{ route('or-characterization-options', ['id' => $question->id]) }}">

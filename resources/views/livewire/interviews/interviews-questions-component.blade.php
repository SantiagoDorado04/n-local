<div>
    ...
    @section('page_header')
        <div class="container-fluid">
            <h1 class="page-title">
                <i class="voyager-video"></i>&nbsp;Preguntas
            </h1>
        </div>
    @stop
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="topic" class="form-control" wire:model.defer="topic">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <button type="button" class="btn btn-success btn-block" wire:click="addQuestion"><i class="voyager-plus"></i> &nbsp;Agregar</button>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach ($questions as $index => $question)
                                    <li class="list-group-item" data-id="{{ $index }}">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-danger" wire:click="removeQuestion({{ $index }})">
                        ...
                        <button class="btn btn-success" wire:click="saveInterview">Guardar Cambios</button>
                    </div>
                </div>
            </div>
        </div>

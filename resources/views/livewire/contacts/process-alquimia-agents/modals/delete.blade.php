        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    <i class="fa fa-trash"></i>&nbsp;{{ __('voyager::generic.delete_question') }} la respuesta?
                </h5>
            </div>
            <div class="modal-footer">
                <button class="btn btn-danger pull-right" wire:click="confirmToGuide()">{{ __('voyager::generic.delete_confirm') }}</button>

<div>
    ...
    @section('page_header')
        <div class="container-fluid">
            <h1 class="page-title">
                <i class="fa fa-calendar"></i> Agendamiento con asesor
            </h1>
        </div>
    @stop
                        ...
                        <div class="row no-margin-bottom">
                            ...
                            @if ($requirementsMet)
                                <div class="embed-container">
                                    {!! $advisorScheduling->embed !!}
                                </div>
                            @else
                                <div class="alert alert-danger">
                                    Debe completar estos pasos antes de poder acceder al agendamiento:
                                </div>
                            @endif
                                                            ...
                                                            @switch($step->step_type)
                                                                ...
                                                                @case('AT')
                                                                    <a class="btn btn-success sm-b"
                                                                        ...
                                                                        <i class="fa fa-arrow-right"></i> Agendamiento con
                                                                        Asesor
                                                                    </a>
                                                                @break
                                                            @endswitch

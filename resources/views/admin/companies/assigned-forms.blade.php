...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="fa fa-folder"></i>&nbsp;Formularios Asignados
        </h1>
    </div>
@stop
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="thwidth"><small>Accion comercial</small></th>
                                        ...
                                        <tbody>
                                            @forelse ($assignedForms as $form)
                                                <tr>
                                                    ...
                                                    <td>{{ $form->commercialFormAction->commercialAction->name }}</td>
                                                        ...
                                                        @php
                                                            ...
                                                            $existingAnswer = DB::table($tableName)
                                                                ...
                                                                ->where(
                                                                    ...
                                                                    '=',
                                                                    $commercialFormAction->commercial_action_id,
                                                                )
                                                                ->first();
                                                        @endphp
                                                ...
                                                @else
                                                    {{-- <button class="btn btn-success sm-b" data-toggle="modal"
                                                        ...
                                                        wire:click="getResult({{ $form->id }})">
                                                        <i class="fa fa-calendar-check-o"></i>&nbsp;Respuestas
                                                    </button> --}}
                                                    <a href="{{ route('companies.answers-form', ['id' => $form->id]) }}"
                                                        class="btn btn-success sm-b" style="text-decoration: none">
                                                        <i class="fa fa-check-square"></i>
                                                        &nbsp;Respuestas
                                                    </a>

                                                    <a href="{{ route('contacts.my-forms.announcements', [
                                                        'form' => $commercialForm->id,
                                                        'action' => $commercialFormAction->commercial_action_id,

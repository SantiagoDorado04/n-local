...
@section('content')
    <div class="page-content">
                    ...
                    <div class="row no-margin-bottom">
                        <div class="col-md-12">
                            <div class="panel panel-bordered" style="margin:0;">
                                <div class="panel-body text-center" style="padding:1%;">
                                    <h4>¡Bienvenido {{ Auth::user()->name }} a la plataforma Nido de Saberes!</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-margin-bottom">
                        <div class="col-md-12">
                            <div class="image-container1">
                                <?php $imageA = Voyager::setting('admin.banner_admin', ''); ?>
                                {{-- <img src="{{ Voyager::image($imageA) }}" alt="Base Image" class="base-image1">
                                <img alt="Overlay Image" class="overlay-image1"
                                    src="{{ asset('assets/img/header-index.svg') }}"> --}}
                                    <?php $imageA = Voyager::setting('admin.banner_admin', ''); ?>
                                <img src="{{ setting('admin.banner_admin') }}" alt="Base Image" class="base-image1">
                                <img alt="Overlay Image" class="overlay-image1"
                                    src="{{ setting('admin.middle_banner_admin') }}">
                            </div>
                        </div>
                    </div>

                    <div class="row no-margin-bottom" style="padding-top: 38%;">
                        <div class="col-lg-12">
                            <div class="row">
                                <!-- Panel con el video embebido, ocupando la mitad del espacio -->
                                <div class="col-md-8">
                                    <div class="panel panel-bordered">
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                @php
                                                    $stage = \App\Stage::where('active', '=', '1')->first();
                                                @endphp
                                                <h4 style="padding: 1.5%; background-color: #FE9941; color: white;">Conoce
                                                    como moverte en el contenido del Nido de saberes:</h4>
                                                <div class="embed-responsive embed-responsive-16by9">
                                                    {!! $stage ? $stage->embebed_video : '' !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    @if (Auth::user()->role_id == '7')
                                        @livewire('contacts.widgets.widgets-contacts-component')
                                    @elseif (Auth::user()->role_id == '1')
                                        @livewire('admin.notifications.notifications-component')
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        {{--         @if (Auth::user()->role_id == '7' || Auth::user()->role_id == '4')
            @livewire('admin.widgets.company-widget-component')
        @elseif(Auth::user()->role_id == '1')
            @livewire('admin.widgets.admin-widget-component')
        @elseif(Auth::user()->role_id == '4')
            @livewire('admin.widgets.guest-widget-component')
        @endif --}}
    </div>
@stop
